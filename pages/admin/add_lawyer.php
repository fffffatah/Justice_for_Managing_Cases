<?php
    include_once "../../php_codes/new_lawyer_validation.php";
?>
                ...
                <table>
                    <tr>
                        ...
                        <td align="right" id="registration-box-style">
                            ...
                            <a href="../../pages/admin/admin_dashboard.php">Cancel</a> <input type="submit" name="reg_button" value="Register"><br><br>
                        </td>
                    </tr>
                </table>
            </form>
