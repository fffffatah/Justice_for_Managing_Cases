<?php
    ...
    if(isset($_POST["reg_button"])){
        ...
        //ADDRESS VALIDATION
        if(empty($_POST["pre_reg_address"])){
            $pre_err_reg_address="Address Required";
            $hasError=true;
        }
        else{
            $pre_reg_address=htmlspecialchars($_POST["pre_reg_address"]);
        }
		if(empty($_POST["per_reg_address"])){
            $per_err_reg_address="Address Required";
            $hasError=true;
        }
        else{
            $per_reg_address=htmlspecialchars($_POST["per_reg_address"]);
        }
        ...
        if(!$hasError){
            ...
            $user->addChild("present_address",$pre_reg_address);
			$user->addChild("permanent_address",$per_reg_address);
