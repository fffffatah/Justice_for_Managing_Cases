...
<html>
	...
	<body>
		<img src="justicelogo.png"; width="80" height="80">
		...
		<tr>
			...
			<th align = "center"><a href= "">ChatBox</a></th>
		</tr>
		<tr>
			<th align = "center"><a href= "ongoing_case_status.php">Ongoing Case Status</a></th>
			<th align = "center"><a href= "">Notification</a></th>
			<th align = "center"><a href= "">New Laywer Request</a></th>
		</tr>
		<tr>		
			<th align = "center"><a href= "profile.php">Profile</a></th>
			<th align = "center"><a href= "">Edit Profile</a></th>
		</tr>
		<tr>		
